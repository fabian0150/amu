<?php
	...
	if(isset($_GET['id'])) {
		...
		$query = "SELECT a.ID, a.band_id, b.name as 'Bandname', a.location_id, l.name, l.address, a.appointment_date, a.record_date
	...
	logData("load Appointments for Location ID: " . $id , "JSON", basename(__FILE__, '.php') , $log_user_id);
